...
// Define Eon-ID configuration message type
type EonId struct {
...
func (x *EonId) Reset() {
	*x = EonId{}
	mi := &file_eon_id_proto_msgTypes[0]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *EonId) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*EonId) ProtoMessage() {}

func (x *EonId) ProtoReflect() protoreflect.Message {
	mi := &file_eon_id_proto_msgTypes[0]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
...
// Deprecated: Use EonId.ProtoReflect.Descriptor instead.
func (*EonId) Descriptor() ([]byte, []int) {
	return file_eon_id_proto_rawDescGZIP(), []int{0}
}

func (x *EonId) GetDatacenterId() int32 {
	if x != nil {
...
func (x *EonId) GetWorkerId() int32 {
	if x != nil {
		return x.WorkerId
	}
	return 0
...
func (x *EonId) GetAutoRegisterWorkerId() bool {
	if x != nil {
...
func (x *EonId) GetRedisKeyPrefix() string {
	if x != nil {
...
func (x *EonId) GetWorkerIdTtl() *durationpb.Duration {
	if x != nil {
...
func (x *EonId) GetHeartbeatInterval() *durationpb.Duration {
	if x != nil {
...
func (x *EonId) GetEnableClockDriftProtection() bool {
	if x != nil {
...
func (x *EonId) GetMaxClockDrift() *durationpb.Duration {
	if x != nil {
...
func (x *EonId) GetClockCheckInterval() *durationpb.Duration {
	if x != nil {
...
func (x *EonId) GetClockDriftAction() string {
	if x != nil {
...
func (x *EonId) GetEnableSequenceCache() bool {
	if x != nil {
...
func (x *EonId) GetSequenceCacheSize() int32 {
	if x != nil {
...
func (x *EonId) GetEnableMetrics() bool {
	if x != nil {
...
func (x *EonId) GetRedisPluginName() string {
	if x != nil {
...
func (x *EonId) GetCustomEpoch() int64 {
	if x != nil {
...
func (x *EonId) GetWorkerIdBits() int32 {
	if x != nil {
...
func (x *EonId) GetSequenceBits() int32 {
	if x != nil {
...
var File_eon_id_proto protoreflect.FileDescriptor

const file_eon_id_proto_rawDesc = "" +
	"\n" +
	"\feon-id.proto\x12\x1alynx.protobuf.plugin.eonId\x1a\x1egoogle/protobuf/duration.proto\"\xf5\x06\n" +
	"\x06eon_id\x12#\n" +
	...
	"\rsequence_bits\x18\x12 \x01(\x05R\fsequenceBitsB*Z(github.com/go-lynx/lynx-eon-id/conf;confb\x06proto3"

var (
	file_eon_id_proto_rawDescOnce sync.Once
	file_eon_id_proto_rawDescData []byte
)

func file_eon_id_proto_rawDescGZIP() []byte {
	file_eon_id_proto_rawDescOnce.Do(func() {
		file_eon_id_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_eon_id_proto_rawDesc), len(file_eon_id_proto_rawDesc)))
	})
	return file_eon_id_proto_rawDescData
}

var file_eon_id_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_eon_id_proto_goTypes = []any{
	(*EonId)(nil),               // 0: lynx.protobuf.plugin.eonId.eon_id
	(*durationpb.Duration)(nil), // 1: google.protobuf.Duration
}
var file_eon_id_proto_depIdxs = []int32{
	1, // 0: lynx.protobuf.plugin.eonId.eon_id.worker_id_ttl:type_name -> google.protobuf.Duration
	1, // 1: lynx.protobuf.plugin.eonId.eon_id.heartbeat_interval:type_name -> google.protobuf.Duration
	1, // 2: lynx.protobuf.plugin.eonId.eon_id.max_clock_drift:type_name -> google.protobuf.Duration
	1, // 3: lynx.protobuf.plugin.eonId.eon_id.clock_check_interval:type_name -> google.protobuf.Duration
...
func init() { file_eon_id_proto_init() }
func file_eon_id_proto_init() {
	if File_eon_id_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_eon_id_proto_rawDesc), len(file_eon_id_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_eon_id_proto_goTypes,
		DependencyIndexes: file_eon_id_proto_depIdxs,
		MessageInfos:      file_eon_id_proto_msgTypes,
	}.Build()
	File_eon_id_proto = out.File
	file_eon_id_proto_goTypes = nil
	file_eon_id_proto_depIdxs = nil
}
